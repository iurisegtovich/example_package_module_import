...
4. INSTALL: python -m pip install --index-url https://test.pypi.org/simple/ example-package-iurisegtovich

5. UPLOAD REAL: python -m twine upload dist/*

6. INSTALL REAL: python -m pip install example-package-iurisegtovich

7. TEST: import example_package
...
8. c. REINSTALL (IGNORING PREVIOUS VERSIONS) python -m pip install -I --index-url https://test.pypi.org/simple/ example-package-iurisegtovich
